...
const unsigned int MAX_CLASSE_COUNT=500;
const unsigned int MAX_MAT_COUNT=100;
const unsigned int MAX_SEANCES_COUNT=1000000;
const unsigned int MAX_SALLETYPE_COUNT=32;
...
/*typedef int CSalleTable[];
typedef int CClasseTable[];
typedef int CProfTable[];
typedef int CMatTable[];*/
...
typedef enum{ooNoOrphSeance,ooNoHeureCreuse,ooNoHeurePointe,
             ooNoSportAfterClass,ooPrefMatin,ooPrefSoir,ooNoSportAfter17h}COptimizeOption;
...
typedef enum{goClassOptimize,goProfOptimize,goNotIncludedSalle,
        ...
        goSortByDureeSeances}CGlobalOptimizeOption;
