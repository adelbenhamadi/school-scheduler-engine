...
{
    //printf("CemSolution created!\n");
}

CemSolution::~CemSolution()
{
    //printf("CemSolution destroyed!\n");
}
...
bool   CemSolution::LoadFromFile(const char* fn)
{
...
bool   CemSolution::SaveToFile(const char* fn)
{
...
int CemSolution::getSeancesCount(const int AIndex,const CEmploiMode emMode)
{
...
bool CemSolution::parkSeance(const int Sindex,bool ABool)
{
    CSeance* se;
}
...
bool   CemSolution::verifyProcessedSeances(bool b)
{
    bool result=true;
//int pass=0;
    int Sindex=0;
...
int    CemSolution::SeanceTableCount(void)
{
...
bool CemSolution::RempliSalle(const int ASeance,const int ASalle,const int ADay,const int AHour,
...
/** @brief (one liner)
  ...
  */
CFillOption CemSolution::getSeanceFillMode(const int Se)
{
...
bool CemSolution::viderSeance2(const int se,bool abool)
{
...
/** @brief (one liner)
  ...
  * (documentation goes here)
  */
CSeance* CemSolution::SeanceTable()
{
    return FSeanceTable;
}
...
/** @brief (one liner)
  ...
  * (documentation goes here)
  */
int CemSolution::SalleTableCount(void)
{
